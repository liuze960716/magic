<template>
 <div class="center">
  <table>
    ...
    <tr>
      <td class="td1" width="60px">1</td>
      <td width="54px">讨论</td>
      <td width="150px">关于旅游之后</td>
      <td width="180px">2019/03/13 14:44:50</td>
      <td width="71px">盖茨</td>
      <td width="180px">2019/03/13 14:44:50</td>
      <td width="58px">1/4</td>
      <td width="54px"><span class="iconfont icon-fujian"></span></td>
      <td width="59px"><span class="liSpan">一般</span></td>
      <td width='228px'>
        <a href="javascript:;">
