 ...
 <div class="center">
  <table>
    ...
    <tr v-for="(item,index) in centerList" :key="index">
      ...
      <td width='300px'>
         <a href="javascript:;" style="background:gray;width:90px;">
          ...
          <a href="javascript:;" style="width:90px;">
            <span class="iconfont icon-xiugaimima"></span>
          修改
          </a>
          <a href="javascript:;" style="background:red;width:90px;">
           <span class="iconfont icon-shanchu"></span>
          删除
          </a>
          <a href="javascript:;" style="background:#00a65a;width:90px;">
