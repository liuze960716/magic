 ...
 <div class="center">
  <table>
    ...
    <tr>
      ...
      <td width="154px">名称</td>
      <td width="150px">层级</td>
      <td width='300px'>操作</td>
    </tr>
    <tr v-for="(item,index) in centerList" :key="index">
      <td class="td1" width="60px">{{item.id}}</td>
      <td width="154px">{{item.ming}}</td>
      <td width="150px">{{item.ceng}}</td>
      <td width='300px'>
          <a href="javascript:;" style="width:60px;">
            <span class="iconfont icon-xiugaimima"></span>
          修改
          </a>
          <a href="javascript:;" style="background:red;width:60px;">
