  ...
  <div class="center">
    <table>
      ...
      <tr>
        ...
        <td width="150px">图标</td>
        <td width="300px">路径</td>
        <td width="71px">类型</td>
        <td width="50px">排序</td>
        <td width="58px">显示</td>
      ...
      <tr v-for="(item,index) in datainfo" :key="index">
        ...
        <td width="150px">{{item.icon}}</td>
        <td width="300px">{{item.lujing}}</td>
        <td width="71px">页面</td>
        <td width="50px">1</td>
        <td width="58px">1</td>
        <td width='228px'>
          <el-button type="text" @click="open">
            <a href="#"><span class="iconfont icon-xiugaimima"></span>上移</a>
          </el-button>
          <el-button type="text" @click="open">
            <a href="#"><span class="iconfont icon-xiugaimima"></span>下移</a>
          </el-button>
          <el-button type="text" @click="open4">
            <a href="#"><span class="iconfont icon-xiugaimima"></span>修改</a>
          </el-button>
          <el-button type="text" @click="open4">
            <a href="#"><span class="iconfont icon-fangdajing"></span>查看</a>
          </el-button>
          <el-button type="text" @click="open2">
            <a href="#"><span class="iconfont icon-shanchu"></span>删除</a>
          </el-button>
        </td>
      </tr>
    </table>
